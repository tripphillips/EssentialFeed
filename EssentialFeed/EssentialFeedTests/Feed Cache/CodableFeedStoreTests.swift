...
class CodableFeedStoreTests: XCTestCase, FailableFeedStoreSpecs {
    ...
    func test_retrieve_deliversFoundValuesOnNonEmptyCache() {
        ...
        expect(sut, toRetrieve: .found(CachedFeed(feed: feed, timestamp: timestamp)))
    }
    ...
    func test_retrieve_hasNoSideEffectsOnNonEmptyCache() {
        ...
        expect(sut, toRetrieveTwice: .found(CachedFeed(feed: feed, timestamp: timestamp)))
    }
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        expect(sut, toRetrieve: .found(CachedFeed(feed: latestFeed, timestamp: latestTimestamp)))
    }
    ...
    func test_delete_deliversErrorOnDeletionError() {
        let noDeletePermissionURL = noPermissionURL()
        let sut = makeSUT(storeURL: noDeletePermissionURL)

        let deletionError = deleteCache(from: sut)

        XCTAssertNotNil(deletionError, "Expected cache deletion on fail")
    }
    ...
    private func noPermissionURL() -> URL {
